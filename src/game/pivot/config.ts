...
export const TRAPS: Record<TrapId, TrapDef> = {
  ...
  flame: floor({ id: 'flame', name: 'Flame Projector', assetId: 'flame-horizontal-topdown-v2', shape: shape([0, 0], [1, 0]), element: 'Fire', family: 'Turret', zone: { checks: 'Plate', damagePerCell: .06, rangePerCell: .06 }, damage: 29, cooldown: 1.0, area: 52, range: 220, targetCap: 4, canTargetFlying: true, color: 0x6a2f22, accent: 0xff963c, glyph: '◖' }),
  ...
  icicle: floor({ id: 'icicle', name: 'Icicle Launcher', assetId: 'icicle-topdown-v1', shape: shape([0, 0]), element: 'Frost', family: 'Turret', zone: { checks: 'Turret', damagePerCell: .06, rangePerCell: .06 }, damage: 34, cooldown: 1.3, area: 0, range: 280, targetCap: 1, canTargetFlying: true, color: 0x315575, accent: 0xc8f7ff, glyph: '◆' }),
  ...
  cannon: floor({ id: 'cannon', name: 'Water Cannon', assetId: 'cannon-horizontal-topdown-v2', shape: shape([0, 0], [1, 0]), element: 'Water', family: 'Turret', damage: 25, cooldown: 1.15, area: 0, range: 270, impulse: 150, targetCap: 1, canTargetFlying: true, color: 0x1a6072, accent: 0x35e4dc, glyph: '➤' }),
  ...
  tesla: floor({ id: 'tesla', name: 'Tesla Coil', assetId: 'tesla-topdown-v1', shape: shape([0, 0], [1, 0], [0, 1], [1, 1]), element: 'Lightning', family: 'Turret', zone: { checks: 'Water', damagePerCell: .06, rangePerCell: .06 }, damage: 27, cooldown: 1.0, area: 0, range: 300, targetCap: 3, canTargetFlying: true, color: 0x4a2b70, accent: 0xb86dff, glyph: 'ϟ' }),
};
