...
export const TRAPS: Record<TrapId, TrapDef> = {
  spikes: floor({ id: 'spikes', name: 'Spikes', assetId: 'spikes-horizontal-topdown-v3', shape: shape([0, 0], [1, 0]), element: 'Physical', damage: 40, cooldown: 1.5, area: 38, range: 0, color: 0x5c4d45, accent: 0xf1c879, glyph: '▲' }),
  saw: floor({ id: 'saw', name: 'Saw Track', assetId: 'saw-horizontal-topdown-v3', shape: shape([0, 0], [1, 0], [2, 0]), element: 'Physical', family: 'Blade', zone: { checks: 'Lightning', damagePerCell: .06 }, damage: 28, cooldown: .9, area: 40, range: 0, canTargetFlying: true, color: 0x5e4d3e, accent: 0xe6bc65, glyph: '◉' }),
  ember: floor({ id: 'ember', name: 'Ember Plates', assetId: 'ember-l-topdown-v3', shape: shape([0, 0], [1, 0], [0, 1], [0, 2]), element: 'Fire', family: 'Plate', zone: { checks: 'Frost', damagePerCell: .06, areaPerCell: .06 }, damage: 30, cooldown: .75, area: 34, range: 0, color: 0x7d2b22, accent: 0xff7136, glyph: '♨' }),
  flame: floor({ id: 'flame', name: 'Flame Projector', assetId: 'flame-horizontal-topdown-v2', shape: shape([0, 0], [1, 0]), element: 'Fire', family: 'Turret', zone: { checks: 'Plate', damagePerCell: .06, rangePerCell: .06 }, damage: 25, cooldown: 1.0, area: 52, range: 220, targetCap: 4, canTargetFlying: true, obstacle: { offset: { x: .46, y: .5 }, radius: 5 }, turret: { baseOffset: { x: .46, y: .5 }, pivotOffset: { x: 1, y: .5 }, muzzleDistance: 48, turnSpeed: 7.2, projectileSpeed: 650 }, color: 0x6a2f22, accent: 0xff963c, glyph: '◖' }),
  frost: floor({ id: 'frost', name: 'Frost Rune', assetId: 'frost-vertical-topdown-v3', shape: shape([0, 0], [0, 1], [0, 2]), element: 'Frost', family: 'Plate', zone: { checks: 'Physical', damagePerCell: .06 }, damage: 22, cooldown: .82, area: 38, range: 0, color: 0x356b87, accent: 0xc9f8ff, glyph: '✦' }),
  icicle: floor({ id: 'icicle', name: 'Icicle Launcher', assetId: 'icicle-topdown-v1', shape: shape([0, 0]), element: 'Frost', family: 'Turret', zone: { checks: 'Turret', damagePerCell: .06, rangePerCell: .06 }, damage: 46, cooldown: 1.3, area: 0, range: 280, targetCap: 1, canTargetFlying: true, obstacle: { offset: { x: .3, y: .5 }, radius: 5 }, turret: { baseOffset: { x: .3, y: .5 }, pivotOffset: { x: .5, y: .5 }, muzzleDistance: 38, turnSpeed: 8.4, projectileSpeed: 860 }, color: 0x315575, accent: 0xc8f7ff, glyph: '◆' }),
  geyser: floor({ id: 'geyser', name: 'Geyser', assetId: 'geyser-vertical-topdown-v3', shape: shape([0, 0], [0, 1]), element: 'Water', zone: { checks: 'Fire', damagePerCell: .06, areaPerCell: .06 }, damage: 11, cooldown: 1.15, area: 46, range: 0, impulse: 112, color: 0x176f7d, accent: 0x41e9e2, glyph: '≈' }),
  cannon: floor({ id: 'cannon', name: 'Water Cannon', assetId: 'cannon-horizontal-topdown-v2', shape: shape([0, 0], [1, 0]), element: 'Water', family: 'Turret', damage: 50, cooldown: 1.15, area: 0, range: 270, impulse: 150, targetCap: 1, canTargetFlying: true, obstacle: { offset: { x: .46, y: .5 }, radius: 5 }, turret: { baseOffset: { x: .46, y: .5 }, pivotOffset: { x: 1, y: .5 }, muzzleDistance: 52, turnSpeed: 7.5, projectileSpeed: 720 }, color: 0x1a6072, accent: 0x35e4dc, glyph: '➤' }),
  mine: floor({ id: 'mine', name: 'Lightning Mine', assetId: 'mine-topdown-v1', shape: shape([0, 0]), element: 'Lightning', family: 'Plate', damage: 25, cooldown: 1.65, area: 58, range: 0, color: 0x56327d, accent: 0xb86dff, glyph: 'ϟ' }),
  tesla: floor({ id: 'tesla', name: 'Tesla Coil', assetId: 'tesla-topdown-v1', shape: shape([0, 0], [1, 0], [0, 1], [1, 1]), element: 'Lightning', family: 'Turret', zone: { checks: 'Water', damagePerCell: .06, rangePerCell: .06 }, damage: 70, cooldown: 1.0, area: 0, range: 300, targetCap: 3, canTargetFlying: true, obstacle: { offset: { x: 1, y: 1 }, radius: 8 }, color: 0x4a2b70, accent: 0xb86dff, glyph: 'ϟ' }),
};
